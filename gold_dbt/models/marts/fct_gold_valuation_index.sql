...
calc AS (
    SELECT
        ...
        (b.total_gold_reserves_tonnes - s.min_res) / NULLIF(s.max_res - s.min_res, 0) AS norm_reserves,
        ((1/b.avg_fx_usd_eur) - s.min_eur) / NULLIF(s.max_eur - s.min_eur, 0) AS norm_eur_strength,
